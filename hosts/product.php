        ...
        <div class="mainBody">
            ...
            <div class="mainBodyList">
                ...
                <?php
                 ...
                 if(Tools::getValue('who', '')=="product"){
                     include ROOT . "/../trade_inc/pages/products/topoptions.inc";
                 }else{
                     include ROOT . "/../trade_inc/pages/common/simpleTop.inc";
                 }
                ?>
                ...
                <div class="listcontent">
                    ...
                    <?php 
                    if(Tools::getValue('who', '')=="product"){
                        include ROOT . "/../trade_inc/pages/products/leftlist.inc";
                        include ROOT . "/../trade_inc/pages/common/middleSegment.inc";
                        include ROOT . "/../trade_inc/pages/products/productdetail.inc";
                    }elseif(Tools::getValue('who', '')=="customscode"){
                        include ROOT . "/../trade_inc/pages/products/customscodedetail.inc";
                    }
