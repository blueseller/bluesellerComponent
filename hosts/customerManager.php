    ...
    <body>
        ...
        <div class="mainBody">
            ...
            <div class="mainBodyList">
                ...
                <?php include ROOT . "/../trade_inc/pages/customerManager/topoptions.inc"; ?>

                <div class="listcontent">

                    <?php include ROOT . "/../trade_inc/pages/customerManager/customerleftlist.inc"; ?>

                    <?php include ROOT . "/../trade_inc/pages/common/middleSegment.inc"; ?>

                    <?php 
                    if(Tools::getValue('who', '')=="customer"){
                        include ROOT . "/../trade_inc/pages/customerManager/rightdetail.inc";
                    }elseif(Tools::getValue('who', '')=="suppliers"){
                        include ROOT . "/../trade_inc/pages/customerManager/rightsupplierdetail.inc";
                    }
